         ...
         <!-- Logo -->
            <div class="nav-logo-container">
               ...
               <div class="nav-logo-icon">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/logo-icon.svg"/>
               </div>
               <div class="nav-logo-text">
                  <img src="<?php echo get_template_directory_uri(); ?>/img/logo-text-horizontal.svg"/>
               </div>
               </a>
            </div><!-- END: Logo -->
         ...
         <!-- Store Info -->
            <div class="store-info-container">
               <div class="full store-info-hours">
                  <p class="text-bold text-gold right">Open Sun-Fri: <span class="text-white">4:30-8:30p</span> 
